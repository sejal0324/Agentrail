  ...
  return (
    <div className="bg-slate-900 border border-slate-800 rounded-xl p-4 shadow-md">
      ...
      <div className="flex items-center justify-between mb-4 border-b border-slate-800 pb-3">
        <div className="flex items-center space-x-2">
          ...
          <div>
            ...
            <p className="text-[11px] text-slate-400">Categorized policy enforcement metrics</p>
          </div>
        </div>
      ...
      {totalBlocks === 0 && !loading ? (
        <div className="py-4 px-3 bg-emerald-500/5 border border-emerald-500/20 rounded-lg flex items-center justify-between text-xs text-emerald-300">
          <div className="flex items-center space-x-2">
            <CheckCircle2 className="w-4 h-4 text-emerald-400" />
            <span>All Guardrails Operational — Zero Policy Violations Recorded</span>
          </div>
          <span className="text-[10px] text-emerald-400/80 font-mono">STATUS: OPTIMAL</span>
        </div>
      ) : (
            ...
            return (
              ...
              >
                <div className="flex items-start justify-between mb-2">
                  <div>
                    <h4 className="text-xs font-medium text-slate-200">{config.label}</h4>
